...
@section('search_bar')
    <div class="relative flex items-center space-x-2">
        <form method="get" action="{{ route('show.search.buy') }}">
            @csrf
                        ...
                        <div class="group bg-white rounded-lg shadow-lg overflow-hidden h-full">
                            ...
                            <div class="p-6">
                                ...
                                <ul class="flex space-x-4">
                                    <li><a href="#" class="text-gray-400 hover:text-blue-600 transition">Twitter</a>
                                    </li>
                                    <li><a href="#"
                                            class="text-gray-400 hover:text-blue-600 transition">Facebook</a></li>
                                    <li><a href="#"
                                            class="text-gray-400 hover:text-blue-600 transition">LinkedIn</a></li>
                                    <li><a href="#"
                                            class="text-gray-400 hover:text-blue-600 transition">Instagram</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-lg w-80 text-center">
                                ...
                                <div class="flex justify-center mb-4" id="starContainer-{{ $agent->id }}">
                                    <span class="text-2xl cursor-pointer"
                                        onclick="setRating({{ $agent->id }},1)">&#9733;</span>
                                    <span class="text-2xl cursor-pointer"
                                        onclick="setRating({{ $agent->id }},2)">&#9733;</span>
                                    <span class="text-2xl cursor-pointer"
                                        onclick="setRating({{ $agent->id }},3)">&#9733;</span>
                                    <span class="text-2xl cursor-pointer"
                                        onclick="setRating({{ $agent->id }},4)">&#9733;</span>
                                    <span class="text-2xl cursor-pointer"
                                        onclick="setRating({{ $agent->id }},5)">&#9733;</span>
                                </div>
