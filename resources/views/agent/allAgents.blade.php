    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-wrap justify-center gap-9  ">
            @foreach ($agents as $agent)
                <div
                    class="group bg-white rounded-lg shadow-lg overflow-hidden h-full mh-80 w-80 flex flex-col justify-between transition duration-300 gap-4 mx-5 hover:shadow-2xl">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <div class="flex items-center space-x-4 mt-4 justify-center">
                            <!-- View Agent Button -->
                            <a href="{{ route('view.detail.agent', $agent->id) }}"
                        ...
                        <ul class="flex justify-center space-x-4 pt-4">
                            <li><a href="#" class="text-gray-400 hover:text-blue-600 transition"><i
                                        class="fab fa-twitter text-xl"></i></a></li>
                            <li><a href="#" class="text-gray-400 hover:text-blue-600 transition"><i
                                        class="fab fa-facebook-f text-xl"></i></a></li>
                            <li><a href="#" class="text-gray-400 hover:text-blue-600 transition"><i
                                        class="fab fa-linkedin-in text-xl"></i></a></li>
                            <li><a href="#" class="text-gray-400 hover:text-blue-600 transition"><i
                                        class="fab fa-instagram text-xl"></i></a></li>
                        </ul>
                    </div>
                </div>
